...
<body>
    ...
    <section id="sec">
        <section id="sec2">
            <div id="foto">
                <img src="prod4.avif" alt="">
            </div>
        </section>
        <section id="sec3">
            <div>
                <h1>Barkleys Cinnamon Candy</h1>
                <h3>BARKLEYS</h3>
                <p>
                    Barkleys Cinnamon brings a bold, spicy flavor to 
                    your breath-freshening routine. Made with natural 
                    cinnamon, these mints offer a warm, invigorating taste 
                    that lasts. The compact tin is perfect for keeping in your 
                    bag or pocket, making it easy to freshen your breath whenever 
                    you need it. An ideal choice for those who prefer a spicy 
                    flavor.
                </p>
                <div id="fav-price">
                    <img src="fav.png" alt="" id="fav">
                    <h3 style="color: black;">5.50 €</h3>
                </div>
                <div id="shto-pay">
