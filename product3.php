...
<body>
    ...
    <section id="sec">
        <section id="sec2">
            <div id="foto">
                <img src="prod3.avif" alt="">
            </div>
        </section>
        <section id="sec3">
            <div>
                <h1>Nutriva Laxilen 60 tablets</h1>
                <h3>Nutriva</h3>
                <p>
                    These tablets are formulated to support healthy digestion and 
                    regular bowel movements. Nutriva Laxilen is ideal for individuals 
                    with occasional constipation, as it helps promote intestinal 
                    motility and ease digestive discomfort.
                </p>
                <div id="fav-price">
                    <img src="fav.png" alt="" id="fav">
                    <h3 style="color: black;">6.10 €</h3>
                </div>
                <div id="shto-pay">
