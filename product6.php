    ...
    <section id="sec">
        ...
        <section id="sec3">
            <div>
                ...
                <h3>Eubiotica</h3>
                <p>
                    An herbal tea that soothes the throat, eases nasal congestion,
                    and supports the immune system. Your go to ally during times 
                    of irritated throat and cough. Its natural, traditional ingredients 
                    help relieve various respiratory discomforts. Fennel and ivy are rich 
                    in nutrients and help fight flu symptoms. Mint helps stimulate 
                    respiratory decongestion. Fennel and honey flavor. Caffeine free.
                </p>
                <div id="fav-price">
                    <img src="fav.png" alt="" id="fav">
                    <h3 style="color: black;">5.00 €</h3>
                </div>
                <div id="shto-pay">
