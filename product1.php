...
<body>
    ...
    <section id="sec">
        <section id="sec2">
            <div id="foto">
                <img src="prod.avif" alt="">
            </div>
        </section>
        <section id="sec3">
            <div>
                <h1>Flexibene Caps 30</h1>
                <h3>Verger Pharma</h3>
                <p>
                    FlexiBene is an advanced joint-health supplement that combines UC-II® -the new generation 
                    of joint-care - with glucosamine, chondroitin, vitamin C, zinc, and manganese. This 
                    formulation helps reduce pain and stiffness, improves mobility, and supports cartilage 
                    regeneration. The different mechanisms of action of its ingredients work in synergy for 
                    maximum effectiveness in joint comfort and function.
                </p>
                <div id="fav-price">
                    <img src="fav.png" alt="" id="fav">
                    <h3 style="color: black;">7.50 €</h3>
                </div>
                <div id="shto-pay">
