    ...
    <section id="sec">
        ...
        <section id="sec3">
            <div>
                ...
                <h3>Chicco</h3>
                <p>
                    An anti mosquito gel designed to protect babies 
                    and children from mosquito bites. Protection from 
                    insect bites is important not only to prevent uncomfortable 
                    itching, but also to reduce the risk of inflammation or 
                    allergic reactions. Its formula makes it easy to apply and 
                    provides long lasting protection. It is gentle on the skin 
                    and suitable for daily use, making it ideal for outdoor activities.
                </p>
                <div id="fav-price">
                    <img src="fav.png" alt="" id="fav">
                    <h3 style="color: black;">7.00 €</h3>
                </div>
                <div id="shto-pay">
