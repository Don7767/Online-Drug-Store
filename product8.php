...
<body>
    ...
    <section id="sec">
        <section id="sec2">
            <div id="foto">
                <img src="prod8.avif" alt="">
            </div>
        </section>
        <section id="sec3">
            <div>
                <h1>Mydoct waterproof plasters</h1>
                <h3>Mydoct</h3>
                <p>
                    These waterproof plasters protect wounds from water, 
                    dirt, and bacteria, helping to prevent infection. Their 
                    breathable design allows the wound to heal properly while 
                    staying dry. Ideal for use while swimming or showering, 
                    they provide long lasting protection.
                </p>
                <div id="fav-price">
                    <img src="fav.png" alt="" id="fav">
                    <h3 style="color: black;">5.30 €</h3>
                </div>
                <div id="shto-pay">
